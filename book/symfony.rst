...
Nilead is built on top of `Symfony2 <http://symfony.com>`_, a modern framework
for PHP. If you are familiar with this tool, you can safely skip this quick
introduction. You should feel like home when working with Nilead.
...
Each time any client wants to access Nilead store page, it all starts with a *request*.
